...
public class GridView_Adapter extends ArrayAdapter<String> {
    ...
    public GridView_Adapter(Context context, List<String> data, String ID, String g_INOUT, String conf_xuong, String conf_khu, ListView lv_dsdata1, ntds_interface ntds_interface) {
